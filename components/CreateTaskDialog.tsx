      ...
      <div className="max-h-[90vh] w-full max-w-lg overflow-y-auto rounded-xl bg-white p-6 shadow-xl dark:bg-zinc-950">
        ...
        <div className="mt-4 flex flex-col gap-3">
          <label className="text-sm">
            <span className="text-zinc-500">{t("common.owner")}</span>
            <select
              value={form.ownerId}
              disabled={lockOwner}
              onChange={(e) =>
          ...
          <label className="text-sm">
            <span className="text-zinc-500">{t("dashboard.epicOptional")}</span>
            <select
              value={form.groupId}
              disabled={lockGroup}
          ...
          <label className="text-sm">
            <span className="text-zinc-500">{t("common.priority")}</span>
            <select
              value={form.priority}
          ...
          <label className="text-sm">
            <span className="text-zinc-500">{t("dashboard.descriptionMarkdown")}</span>
            <textarea
